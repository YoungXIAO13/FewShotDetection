...
class coco(imdb):
    def __init__(self, image_set, year):
        ...
        self.coco_cats = [c['name'] for c in cats]
    ...
    def _load_coco_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            if obj['category_id'] not in coco_cat_id_to_class_ind.keys():
                continue
            ...
            if obj['iscrowd']:
                # Set overlap to -1 for all classes for crowd objects so they will be excluded during training
                overlaps[ix, :] = -1.0
            else:
                overlaps[ix, cls] = 1.0
